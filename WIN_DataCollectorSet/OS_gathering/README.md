Ansible Role: OS-Windows2022/WIN_DataCollectorSet/OS_gathering
=======================================================
# Description
本ロールは、Windows Server 2022に関するデータコレクタについての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/WIN_DataCollectorSet/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/WIN_DataCollectorSet.yml`
