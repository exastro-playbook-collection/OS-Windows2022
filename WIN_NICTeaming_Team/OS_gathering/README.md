Ansible Role: OS-Windows2022/WIN_NICTeaming_Team/OS_gathering
=======================================================
# Description
本ロールは、Windows Server 2022に関するNICチーミング設定（チーム）についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/WIN_NICTeaming_Team/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/WIN_NICTeaming_Team.yml`
