Ansible Role: OS-Windows2022/WIN_ErrorReporting/OS_gathering
=======================================================
# Description
本ロールは、Windows Server 2022に関するエラーレポーティング設定についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/WIN_ErrorReporting/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/WIN_ErrorReporting.yml`
