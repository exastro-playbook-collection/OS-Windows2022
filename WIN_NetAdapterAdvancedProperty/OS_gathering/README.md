Ansible Role: OS-Windows2022/WIN_NetAdapterAdvancedProperty/OS_gathering
=======================================================
# Description
本ロールは、Windows Server 2022に関するネットワークアダプタ詳細設定についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/WIN_NetAdapterAdvancedProperty/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/WIN_NetAdapterAdvancedProperty.yml`
...
            └── 管理対象マシンホスト名 or IPアドレス/
                 └── OS/  # OS設定ロール向け専用のフォルダ
                        WIN_NetAdapterAdvancedProperty.yml  # パラメータ
~~~
...
    │    └── 管理対象マシンホスト名 or IPアドレス/
    │         └── OS/
    │              └── WIN_NetAdapterAdvancedProperty/  # 収集データ
    │                   │── command/
    │                   │      ・・・
    │                   └── file/
    │                          ・・・
