Ansible Role: OS-Windows2022/WIN_NtpClientSetting/OS_gathering
=======================================================
# Description
本ロールは、Windows Server 2022に関する時刻同期（Windows Timeサービス）についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/WIN_NtpClientSetting/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/WIN_NtpClientSetting.yml`
...
            └── 管理対象マシンホスト名 or IPアドレス/
                 └── OS/  # OS設定ロール向け専用のフォルダ
                        WIN_NtpClientSetting.yml  # パラメータ
~~~
