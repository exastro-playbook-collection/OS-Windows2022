Ansible Role: OS-Windows2022/WIN_EnvSetting/OS_gathering
=======================================================
# Description
本ロールは、Windows Server 2022に関する環境変数についての情報の取得を行います。
...
- `<VAR_OS_gathering_dest>/<ホスト名/IP>/OS/WIN_EnvSetting/`
...
- `<VAR_extracting_dest>/<ホスト名/IP>/OS/WIN_EnvSetting.yml`
